  ...
  return /* @__PURE__ */ jsxDEV("div", { className: "min-h-screen flex flex-col items-center justify-center px-4 py-8", style: { backgroundColor: SAND }, children: [
    ...
    /* @__PURE__ */ jsxDEV("div", { className: "w-full max-w-sm", children: [
      /* @__PURE__ */ jsxDEV("div", { className: "text-center mb-8", children: [
        ...
        /* @__PURE__ */ jsxDEV("h1", { className: "text-2xl font-bold", style: { color: BROWN }, children: t("livreur_title") }, void 0, false),
      ...
      /* @__PURE__ */ jsxDEV("div", { className: "rounded-2xl border overflow-hidden mb-4", style: { background: "white", borderColor: BORDER }, children: [
        /* @__PURE__ */ jsxDEV("div", { className: "border-b", style: { borderColor: BORDER }, children: [
          /* @__PURE__ */ jsxDEV("div", { className: "px-4 py-2 flex items-center gap-3", style: { background: "#FFF5F2" }, children: [
            /* @__PURE__ */ jsxDEV(Mail, { className: "h-4 w-4 flex-shrink-0", style: { color: TC } }, void 0, false),
        ...
        /* @__PURE__ */ jsxDEV("div", { children: [
          /* @__PURE__ */ jsxDEV("div", { className: "px-4 py-2 flex items-center gap-3", style: { background: "#FFF5F2" }, children: [
            /* @__PURE__ */ jsxDEV(Lock, { className: "h-4 w-4 flex-shrink-0", style: { color: TC } }, void 0, false),
      ...
      error && /* @__PURE__ */ jsxDEV("p", { className: "text-center text-sm font-medium mb-4 px-2", style: { color: TC }, children: error }, void 0, false),
      /* @__PURE__ */ jsxDEV(
        "button",
        {
